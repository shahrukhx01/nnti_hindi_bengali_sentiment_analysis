...
* `Hindi_Self_Attention_Binary_Classifier.ipynb` contains the runtime code for training classifier on train set and evaluating on test set.
...
* `main.py` alternate to `Hindi_Self_Attention_Binary_Classifier.ipynb` if you prefer shell based training/testing of model.
